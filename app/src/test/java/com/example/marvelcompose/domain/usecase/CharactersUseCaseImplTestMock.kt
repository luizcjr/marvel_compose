...
import com.example.marvelcompose.data.repository.CharacterRepositoryImplTestMock
...
object CharactersUseCaseImplTestMock {
    ...
    private val storiesResponse = DetailsReponse(1, "Series 1", thumbnailResponse)
    private val storiesResponse2 = DetailsReponse(2, "Series 2", thumbnailResponse)
